...
export default function SignupPage() {
    ...
    // this will run when the changes happened in the user
    useEffect(() => {
    ...
    return (
        <div className="flex text-white bg-gray-950 flex-col items-center justify-center min-h-screen py-2">
            <h1>{loading ? "Processing" : "Signup"}</h1>
            <hr />
            <label htmlFor="username"></label>
            <input type="text" id="username" className="p-2 border text-black border-gray-300 rounded-lg mb-4 focus:outline-none focus:border-gray-600"
                value={user.username}
